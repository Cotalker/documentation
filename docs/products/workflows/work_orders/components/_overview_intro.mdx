...
:::note
- When used within the [**Corrective Maintenance**](/docs/products/corrective_maintenance/landing/overview) product, supervisors can create _work orders_ upon receiving a maintenance _notification_.
...
- [Corrective Maintenance Product](/docs/products/corrective_maintenance/landing/overview)
