...
Layla can see the quote in the work order's channel. Additionally, the <a href={props.quotes}>quotes workflow</a> is initiated with the company's budget manager.
