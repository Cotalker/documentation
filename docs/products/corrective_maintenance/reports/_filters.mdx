...
<summary>Descripción de Filtros</summary>
<div>
...
**Categoría Activo** | Muestra data relevante a las [categorías de equipo](/docs/products/corrective_maintenance/master_data/equipment_category) seleccionadas. | Selecciona de la lista las _categorías de equipo_ por los cuales quieres filtrar la data.
**Activos** | Filtra por los activos o [equipos](/docs/products/corrective_maintenance/master_data/equipment) que están o han pasado por mantenimiento. | 
