...
- [COTEvent]([COTEvent](/docs/documentation/models/webhooks/event): Trigger event data models. COTEvent data can be viewed in [webhook logs](http://localhost:3000/docs/documentation/admin/admin_webhooks#logs) or as an object within [COTWebhookLog.event](http://localhost:3000/docs/documentation/models/webhooks/webhooklog).
