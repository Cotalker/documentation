...
| branding | Allows customizing certain aspects of Cotalker's UI, i.e., platform colors, images, and text. Also enables login authentication with an organization's Google and Microsoft accounts. | [object](docs/documentation/models/company/company_branding) | View the complete [branding object description](docs/documentation/models/company/company_branding). <br/>Visit the [Branding Settings](/docs/documentation/admin/special_configurations/branding) section for examples and tips. |
