...
1. From the **Main Menu Bar**, access the <span className="badge badge--primary">Administrator</span> and open the <span className="badge badge--primary">Workflow Section</span>.
...
<img alt="workflow-group" className="img_sizing item shadow--tl item shadow--tl" src={useBaseUrl('img/tutorial_workflow_00.png')} />
<br/>
...
3. Press the <span className="badge badge--primary">+</span> button to create a new _workflow_.

<img alt="create workflow" className="img_sizing item shadow--tl item shadow--tl" src={useBaseUrl('img/tutorial_workflow_01.png')} />
<br/>

_The following settings panel will show up:_

<img alt="workflow settings panel" className="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_workflow_02.png')} />
<br/>
...
6. From the <span className="badge badge--primary">Workflows</span> settings panel, click on the newly created *Task Manager Flow* workflow for editing.

  _The following image will help you find where the Task Manager Flow workflow is located._

<img alt="task manager" className="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_workflow_03.png')} />
<br/>

  _Once you enter the workflow, you should see the following:_

<img alt="settings panel" className="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_workflow_04.png')} />
<br/>
...
7. Create the five different _states_ that tasks will be enabled to assume.
    ...
    1. Create the first out of five _states_:
        1. From the <span className="badge badge--primary">Create Workflow</span> settings panel, go to the <span className="badge badge--primary">States</span> section and press the <span className="badge badge--primary">+</span> button as shown in the picture:
...
8. From the <span className="badge badge--primary">Create Workflow</span> settings panel, go to the <span className="badge badge--primary">States</span> section and set the **Initial State**: to `Backlog`.

  _Your screen should look something like this:_

<img alt="workflow" className="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_workflow_07.png')} />
<br/>
...
9. Associate the _states_ among themselves.
    ...
    1. Configure the ***Backlog*** state.
        1. From the list of _states_ in the <span className="badge badge--primary">States</span> section, click the ***Backlog*** state. The following settings panel will appear:

        ![create state](/img/tutorial_workflow_08.png)

        2. In the <span className="badge badge--primary">State changes</span> section, press <span className="badge badge--primary">+ Add State Change</span>. The following fields will appear:
        ...
        4. Add the next state change.
            1. Press <span className="badge badge--primary">+ Add State Change</span>
    ...
    2. Configure the ***Doing*** state.
        1. From the list of _states_ in the <span className="badge badge--primary">States</span> section, click the ***Doing*** state.
        2. Press <span className="badge badge--primary">+ Add State Change</span> and set the following:
            * **State**: `Backlog`
            * **Can change**: `*`
        3. Press <span className="badge badge--primary">+ Add State Change</span> and set the following:
            * **State**: `Waiting`
            * **Can change**: `*`
        4. Press <span className="badge badge--primary">+ Add State Change</span> and set the following:
            * **State**: `Ready`
            * **Can change**: `*`
        5. Press <span className="badge badge--primary">Save</span>.
    ------
    3. Configure the ***Waiting*** state.
        1. From the list of _states_ in the <span className="badge badge--primary">States</span> section, click the ***Waiting*** state.
        2. Press <span className="badge badge--primary">+ Add State Change</span> and set the following:
            * **State**: `Doing`
            * **Can change**: `*`
        3. Press <span className="badge badge--primary">+ Add State Change</span> and set the following:
    ...
    4. Configure the ***Not implemented*** state.
        1. From the list of _states_ in the <span className="badge badge--primary">States</span> section, click the ***Not implemented*** state.
        2. Press <span className="badge badge--primary">+ Add State Change</span> and set the following:
            * **State**: `Backlog`
            * **Can change**: `*`
        3. Press <span className="badge badge--primary">Save</span>.
...
<img alt="state machine ready" className="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_workflow_10.png')} />
<br/>
...
11. After saving, you are sent back to the <span className="badge badge--primary">Workflows</span> settings panel. 

_You will see the following screen:_

<img alt="task manager" className="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_workflow_11.png')} />
<br/>
...
13. Press <span className="badge badge--primary">Save</span>.
...
<img alt="task manager view" className="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_workflow_12.png')} />
<br/>
<br/>
