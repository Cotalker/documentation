...
10. Build the _routine_:
    ...
    3. Also set the following:
        ...
        - In the **Name** field, press <span class="badge badge--primary">+ Add Item</span>, then set:
        ...
        - **User**: `$VALUE#user`
          ...
          :::
        -------
        - In **Answers**, press <span class="badge badge--primary">+ Add Item</span>, then set:
            - **Item**: `$VALUE#uuid`
        -------
        ...
        - **Dynamic Field 2**: `$VALUE#data|[find=>identifier=departmenttask_00]|process|0`
          ...
          :::
        -------
        - In **Assignee**, press <span class="badge badge--primary">+ Add Item</span>, then set: 
            - **Item**: `$VALUE#user`
