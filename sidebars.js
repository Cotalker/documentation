module.exports = {
  ...
  productos_es: [
    {
      ...
      link: {
        type: 'doc',
        id: 'productos_es/products_overview'
      },
      items: [
        'productos_es/corrective_maintenance/cm_overview',
        // 'products/preventive_maintenance/pm_overview',
        // 'products/work_order_product/wo_overview',
        // 'products/purchase_order_product/po_overview',
        // 'products/service_orders/so_overview'
    ...
    // 'productos_es/setup/setup_overview'
  ],
  workflow_workorders_cm_es: [
    {
      type: 'doc',
      id: 'products/corrective_maintenance/cm_overview',
      label: 'Volver a Mantenimiento Correctivo...'
    },
    {
      type: 'category',
      label: 'Flujo de Trabajo de Órdenes de Trabajo',
      link: {
        type: 'doc',
        id: 'products/workflows/work_orders/related-product/cm/overview_intro',
      },
  ...
  workflow_notifications: [
    {
      type: 'doc',
      id: 'productos_es/corrective_maintenance/cm_overview',
      label: 'Volver a Mantenimiento Correctivo...'
    },
    {
      type: 'category',
      label: 'Flujo de Trabajo de Notificaciones',
      link: {
        type: 'doc',
        id: 'productos_es/workflows/notifications/overview',
      },
      collapsed: false,
      collapsible: false,
      items: [
        'productos_es/workflows/notifications/examples',
        'productos_es/workflows/notifications/workflow',
        {
          type: 'category',
          label: 'Paso a Paso',
          link: {
            type: 'doc',
            id: 'productos_es/workflows/notifications/surveys',
          },
          collapsed: false,
          collapsible: false,
          items: [
            'productos_es/workflows/notifications/surveys-report',
            'productos_es/workflows/notifications/surveys-validate',
          ]
        }
      ],
    }
