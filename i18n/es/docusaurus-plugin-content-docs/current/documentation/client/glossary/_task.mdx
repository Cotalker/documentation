...
:::info
- **Tasks** are created within _task groups_.  
- Every **task group** is the representation of a _workflow group_.  
- A **workflow group** can contain one or more _workflows_.
:::
