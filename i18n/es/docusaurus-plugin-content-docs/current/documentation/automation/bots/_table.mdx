...
| [Custom Javascript Code (1.0.0)](/docs/documentation/automation/bots/ccjs-1.0.0) | Sandboxed JS runner. | _CCJS_ |  
...
| [Iterate (1.0.0)](/docs/documentation/automation/bots/fceach-1.0.0) | Iterate over an Array | _FCEach_ |  
| [Conditional (1.0.0)](/docs/documentation/automation/bots/fcifelse-1.0.0) | Execute the next stage conditionally based on the operator's left and right hand | _FCIfElse_ |  
| [Wait (1.0.0)](/docs/documentation/automation/bots/fcsleep-1.0.0) | Execute the next stage after the defined milliseconds | _FCSleep_ |  
| [Multiple switch (1.0.0)](/docs/documentation/automation/bots/fcswitchall-1.0.0) | Execute all stages conditionally and in parallel according to the operator's left and right hand | _FCSwitchAll_ |  
| [Switch (1.0.0)](/docs/documentation/automation/bots/fcswitchone-1.0.0) | Conditionally executes the next stage based on the left and right hand of the operator | _FCSwitchOne_ |  
| [Run legacy bot (1.0.0)](/docs/documentation/automation/bots/nwbotv2v3-1.0.0) | Makes a network request to execute a legacy bot | _NWBotV2V3_ |  
| [Network request (2.0.0)](/docs/documentation/automation/bots/nwrequest-2.0.0) | Makes a network request | _NWRequest_ |  
| [Network request (1.0.0)](/docs/documentation/automation/bots/nwrequest-1.0.0) | Makes a network request | _NWRequest_ |  
| [Action Button (2.0.0)](/docs/documentation/automation/bots/pbactionbutton-2.0.0) |  | _PBActionButton_ |  
| [Action Button (1.0.0)](/docs/documentation/automation/bots/pbactionbutton-1.0.0) |  | _PBActionButton_ |  
...
| [Search for answers (1.0.0)](/docs/documentation/automation/bots/pbanswerchecker-1.0.0) | Search for form responses | _PBAnswerChecker_ |  
...
| [Change Task Status (1.0.0)](/docs/documentation/automation/bots/pbchangestate-1.0.0) | Change the status of a Task | _PBChangeState_ |  
...
| [Edit Channel Users (1.0.0)](/docs/documentation/automation/bots/pbchanneladduser-1.0.0) | Add or remove users from a Channel | _PBChannelAddUser_ |  
...
| [Get Task from a Channel (1.0.0)](/docs/documentation/automation/bots/pbchanneltotaskse-1.0.0) | Gets the Task associated with a Channel (if any) | _PBChannelToTaskSE_ |  
...
| [Clean channels (1.0.0)](/docs/documentation/automation/bots/pbcleanchannel-1.0.0) | Delete the messages that have the indicated channels | _PBCleanChannel_ |  
...
| [Copy messages (1.0.0)](/docs/documentation/automation/bots/pbcopysurvey-1.0.0) | Copy messages from one Channel to another | _PBCopySurvey_ |  
| [Create Channel (2.0.0)](/docs/documentation/automation/bots/pbcreatechannel-2.0.0) | Create a new Channel | _PBCreateChannel_ |  
| [Create Channel (1.0.0)](/docs/documentation/automation/bots/pbcreatechannel-1.0.0) | Create a new Channel | _PBCreateChannel_ |  
| [Create Property (2.0.0)](/docs/documentation/automation/bots/pbcreateproperty-2.0.0) | Create a new Property | _PBCreateProperty_ |  
| [Create Property (1.0.0)](/docs/documentation/automation/bots/pbcreateproperty-1.0.0) | Create a new Property | _PBCreateProperty_ |  
...
| [Create Task (1.0.0)](/docs/documentation/automation/bots/pbcreatetask-1.0.0) | Create a new Task | _PBCreateTask_ |  
| [Create User (2.0.0)](/docs/documentation/automation/bots/pbcreateuser-2.0.0) | Create a new User | _PBCreateUser_ |  
| [Create User (1.0.0)](/docs/documentation/automation/bots/pbcreateuser-1.0.0) | Create a new User | _PBCreateUser_ |  
| [Duplicate Task (2.0.0)](/docs/documentation/automation/bots/pbduplicatetask-2.0.0) |  | _PBDuplicateTask_ |  
| [Duplicate Task (1.0.0)](/docs/documentation/automation/bots/pbduplicatetask-1.0.0) |  | _PBDuplicateTask_ |  
...
| [Change Form to edit mode (1.0.0)](/docs/documentation/automation/bots/pbeditablesurvey-1.0.0) | Change a set of forms to edit mode | _PBEditableSurvey_ |  
| [Send email (3.0.0)](/docs/documentation/automation/bots/pbemail-3.0.0) | Send an email | _PBEmail_ |  
| [Send email (2.0.0)](/docs/documentation/automation/bots/pbemail-2.0.0) | Send an email | _PBEmail_ |  
| [Send email (1.0.0)](/docs/documentation/automation/bots/pbemail-1.0.0) | Send an email | _PBEmail_ |  
| [Get Channel Messages (2.0.0)](/docs/documentation/automation/bots/pbgetchannelmessages-2.0.0) |  | _PBGetChannelMessages_ |  
| [Get Channel Messages (1.0.0)](/docs/documentation/automation/bots/pbgetchannelmessages-1.0.0) |  | _PBGetChannelMessages_ |  
| [Send gif (1.0.0)](/docs/documentation/automation/bots/pbgiphy-1.0.0) | Send a gif to a Channel | _PBGiphy_ |  
...
| [Google Calendar Integration (1.0.0)](/docs/documentation/automation/bots/pbgooglecalendar-1.0.0) | Domain wide integration | _PBGoogleCalendar_ |  
...
| [Hide messages (1.0.0)](/docs/documentation/automation/bots/pbhidemessages-1.0.0) | Hide messages from a Channel | _PBHideMessages_ |  
| [Send message (2.0.0)](/docs/documentation/automation/bots/pbmessage-2.0.0) | Send a message to a set of channels | _PBMessage_ |  
| [Send message (1.0.0)](/docs/documentation/automation/bots/pbmessage-1.0.0) | Send a message to a set of channels | _PBMessage_ |  
| [Payments (2.0.0)](/docs/documentation/automation/bots/pbpayments-2.0.0) |  | _PBPayments_ |  
| [Payments (1.0.0)](/docs/documentation/automation/bots/pbpayments-1.0.0) |  | _PBPayments_ |  
...
| [Create PDF (1.0.0)](/docs/documentation/automation/bots/pbpdf-1.0.0) | Create a PDF from a local file or a URL | _PBPdf_ |  
| [PDF Extractor (1.0.0)](/docs/documentation/automation/bots/pbpdfextractor-1.0.0) | Convert data and tables from PDFs to JSON | _PBPDFExtractor_ |  
| [Generate QR code (2.0.0)](/docs/documentation/automation/bots/pbqrcode-2.0.0) | Generate a QR code | _PBQRCode_ |  
| [Generate QR code (1.0.0)](/docs/documentation/automation/bots/pbqrcode-1.0.0) | Generate a QR code | _PBQRCode_ |  
| [Script (2.0.0)](/docs/documentation/automation/bots/pbscript-2.0.0) |  | _PBScript_ |  
| [Script (1.0.0)](/docs/documentation/automation/bots/pbscript-1.0.0) |  | _PBScript_ |  
...
| [Submit Form (1.0.0)](/docs/documentation/automation/bots/pbsendsurvey-1.0.0) | Send a Form to a Channel | _PBSendSurvey_ |  
...
| [Edit users of a Task (1.0.0)](/docs/documentation/automation/bots/pbtaskaddeditor-1.0.0) | Add or remove users from a Task | _PBTaskAddEditor_ |  
| [Generate HTML (3.0.0)](/docs/documentation/automation/bots/pbtemplate-3.0.0) | Generates an HTML from a template and an object with data | _PBTemplate_ |  
...
| [Generate HTML (1.0.0)](/docs/documentation/automation/bots/pbtemplate-1.0.0) | Generates an HTML from a template and an object with data | _PBTemplate_ |  
| [Update Channel (2.0.0)](/docs/documentation/automation/bots/pbupdatechannel-2.0.0) | Update a Channel | _PBUpdateChannel_ |  
| [Update Channel (1.0.0)](/docs/documentation/automation/bots/pbupdatechannel-1.0.0) | Update a Channel | _PBUpdateChannel_ |  
...
| [Update Property (1.0.0)](/docs/documentation/automation/bots/pbupdateproperty-1.0.0) | Update a Property | _PBUpdateProperty_ |  
...
| [Update Task (1.0.0)](/docs/documentation/automation/bots/pbupdatetask-1.0.0) | Update a Task | _PBUpdateTask_ |  
| [Update User (2.0.0)](/docs/documentation/automation/bots/pbupdateuser-2.0.0) | Update a User | _PBUpdateUser_ |  
| [Update User (1.0.0)](/docs/documentation/automation/bots/pbupdateuser-1.0.0) | Update a User | _PBUpdateUser_ |  
| [WhatsApp Integration (1.0.0)](/docs/documentation/automation/bots/pbwhatsapp-1.0.0) | Send message via WhatsApp | _PBWhatsApp_ |
