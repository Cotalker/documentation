...
After accepting a _work order_, contractors can submit a quote through the work order's _channel_. They can do this by filling out the <a href={props.quotes}>New Quote</a> form. This form is tied to master data to help easily choose services and available materials, along with their costs and stocks, respectively.
