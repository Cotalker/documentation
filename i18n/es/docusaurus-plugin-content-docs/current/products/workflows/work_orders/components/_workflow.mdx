...
1. **Reported**: Either a supervisor or a bot has filled out and submitted the _Create Work Order_ form. Technical teams and contractors are informed of the work order. They can now review the information, ask for more details, and view its history. To pass to the workflow's next step, a technical team or contractor must accept the work order by submitting the _Accept Work Order_ form.
