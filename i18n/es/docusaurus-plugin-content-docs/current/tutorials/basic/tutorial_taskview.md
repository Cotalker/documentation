...
1. From the **Main Menu Bar**, access the <span class="badge badge--primary">Task Manager</span> group.

<img alt="Main menu bar" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_00.png')} />
<br/>
...
2. From the **Task Manager** channel list, press the <span class="badge badge--primary">Task View</span> button.

<img alt="add task button" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_01.png')} />
<br/>

  This will send you to the _Task View_ window:

<img alt="task mana" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_02.png')} />
<br/>
...
3. Prese the <span class="badge badge--primary">Create new task</span> icon. A side panel will then slide open on the right:

<img alt="create new task" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_03.png')} />
<br/>
...
<img alt="task name field" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_04.png')} />
<br/>
...
<img alt="side panel" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_05.png')} />
<br/>
...
7. Create the first _filter_ (tasks grouped by status):
    1. Press the <span class="badge badge--primary">Filter</span> icon. 
    2. Then, press the <span class="badge badge--primary">Configuration</span> icon that shows up afterward. 
    3. Finally, you will see the **Filters** side panel open up on the left side of the window.

    _Follow the sequence shown below:_

<img alt="filter button" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_06a.png')} />
<br/>
...
8. From the **Filters** settings panel, set up the _Filter_ as follows:
    ...
    2. In the **Group by** section, press <span class="badge badge--primary">ADD CRITERIA</span>.
        - A **Field** pad will appear with options in a pull down menu. 
        - Select `Status`.
    3. In the **Order by** section, press <span class="badge badge--primary">ADD CRITERIA</span>. 
        - A **Field** pad will appear with options in a pull down menu. 
        - Select `Department`.
...
<img alt="status filter" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_07.png')} />
<br/>
...
9. Create the second _filter_ (high importance tasks grouped by department).
    ...
    <img alt="new filter" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_08.png')} />
    <br/>

    2. Set the panel as follows:
        - **Preset**: `Critical task by department`.
        - In the **Group by** section, press <span class="badge badge--primary">ADD CRITERIA</span>. Set the following: 
          - **Field**: `Department`.
        - In the **Order by** section, press <span class="badge badge--primary">ADD CRITERIA</span>. Set the following:
          - **Field**: `Status`.
        - In the **Filter by** section, press <span class="badge badge--primary">ADD FILTER</span>. Set the following:
...
<img alt="my tasks filter" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_09.png')} />
<br/>
...
<img alt="my tasks filter" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_10.png')} />
<br/>
<br/>
...
## Result {#result}
From now on, everytime you go to the _Task view_, you can use the filter presets you have just created. To do this, simply click con the <span class="badge badge--primary">Filter</span> icon and choose a preset from the drop-down menu, as shown below:

<img alt="stored filter presets" class="img_sizing item shadow--tl" src={useBaseUrl('img/tutorial_taskview_results_00.png')} width= "60%" height= "60%" />
<br/>
<br/>
